...
public partial class Base64DecoderView : UserControl
{
    private Border? _inputBorder;

    public Base64DecoderView()
    {
        InitializeComponent();
    ...
    private void InputBorder_Drop(object? sender, DragEventArgs e)
    {
        try
        {
            ...
            if (this.DataContext is Base64DecoderViewModel viewModel)
            {
                _ = viewModel.SetSelectedFileAsync(filePath);
            }
