...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AppSettings>(entity =>
        {
            ...
            entity.Property(e => e.FontSizePreference).IsRequired().HasMaxLength(10).HasDefaultValue(global::DevCrew.Core.Domain.Models.AppSettings.DefaultFontSizePreference);
            entity.Property(e => e.UiFontFamily).IsRequired().HasMaxLength(EntityConfiguration.FontFamilyKeyMaxLength).HasDefaultValue(global::DevCrew.Core.Domain.Models.AppSettings.DefaultUiFontFamily);
            entity.Property(e => e.HeadingFontFamily).IsRequired().HasMaxLength(EntityConfiguration.FontFamilyKeyMaxLength).HasDefaultValue(global::DevCrew.Core.Domain.Models.AppSettings.DefaultHeadingFontFamily);
            entity.Property(e => e.ButtonFontFamily).IsRequired().HasMaxLength(EntityConfiguration.FontFamilyKeyMaxLength).HasDefaultValue(global::DevCrew.Core.Domain.Models.AppSettings.DefaultButtonFontFamily);
            entity.Property(e => e.ContentFontFamily).IsRequired().HasMaxLength(EntityConfiguration.FontFamilyKeyMaxLength).HasDefaultValue(global::DevCrew.Core.Domain.Models.AppSettings.DefaultContentFontFamily);
            entity.Property(e => e.CreatedAt).IsRequired();
